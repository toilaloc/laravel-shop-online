                ...
                <div class="col-lg-8 contact_col">
                    <div class="get_in_touch">
                        ...
                        <div class="contact_form_container">
                            <form action="{{url('lien-he')}}" method="post" class="contact_form">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-6">
                                        <!-- Name -->
                                        <label for="contact_name">Tên đầy đủ*</label>
                                        <input type="text" id="contact_name" class="contact_input" name="name">
                                    </div>
                                    <div class="col-xl-6 last_name_col">
                                        <!-- Last Name -->
                                        <label for="contact_last_name">Email*</label>
                                        <input type="text" id="contact_last_name" class="contact_input" name="email">
                                    </div>
                                </div>
                                <div>
                                    <!-- Phone -->
                                    <label for="contact_company">SĐT</label>
                                ...
                                <div>
                                    ...
                                    <textarea id="contact_textarea" class="contact_input contact_textarea" name="message"></textarea>
                                </div>
